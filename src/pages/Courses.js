            ...
            <Row>
              <Col md={4} className="mb-4 text-center">
                <div className="p-4 rounded-lg" style={{ 
                  ...
                  <h5 style={{ color: 'white', fontWeight: 'bold' }}>Small Batch Training</h5>
                  <p style={{ color: 'rgba(255,255,255,0.9)' }}>
                    Maximum 15 students per batch for personalized attention, unlike other institutes with 50+ students
                  </p>
                </div>
              </Col>
              <Col md={4} className="mb-4 text-center">
                <div className="p-4 rounded-lg" style={{ 
                  ...
                  <div style={{ fontSize: '3rem' }} className="mb-3">🎯</div>
                  <h5 style={{ color: 'white', fontWeight: 'bold' }}>Quality Over Quantity</h5>
                  <p style={{ color: 'rgba(255,255,255,0.9)' }}>
                    We focus on quality education with 1:1 mentoring sessions and real industry project experience
                  </p>
                </div>
              </Col>
              <Col md={4} className="mb-4 text-center">
                <div className="p-4 rounded-lg" style={{ 
                  ...
                  <div style={{ fontSize: '3rem' }} className="mb-3">💰</div>
                  <h5 style={{ color: 'white', fontWeight: 'bold' }}>Flexible Payment</h5>
                  <p style={{ color: 'rgba(255,255,255,0.9)' }}>
                    Pay only 30% initially, rest according to syllabus completion. 10 days money back guarantee
                  </p>
                </div>
              </Col>
            </Row>
